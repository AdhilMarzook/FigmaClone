...
import { BaseMetadata, GetThreadsOptions, CommentBody, ThreadData, Resolve, ToImmutable, RoomEventMessage, CommentData, RoomInitializers } from '@liveblocks/core';
...
declare function useRoomContextBundle(): {
    ...
    useThreads: (options?: UseThreadsOptions<BaseMetadata> | undefined) => ThreadsState<BaseMetadata>;
    ...
    suspense: {
        ...
        useThreads: (options?: UseThreadsOptions<BaseMetadata> | undefined) => ThreadsStateSuccess<BaseMetadata>;
...
export { ClientSideSuspense, type MutationContext, type ResolveMentionSuggestionsArgs, type ResolveUsersArgs, type UseThreadsOptions, createRoomContext, useRoomContextBundle };
