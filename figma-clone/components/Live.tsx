...
const Live = () => {
    const others = useOthers (); // TODO 
    const [{ cursor }, updateMyPresence ] = useMyPresence()as any; // to trigger updates when my presence changes
    ...
    const handlePointerLeave = useCallback((event: React.PointerEvent) => {
        ...
        updateMyPresence({ cusor: null,message:null});
    },[])
    ...
    >
       <h1 className="text-5xl text-white">hellow</h1>
